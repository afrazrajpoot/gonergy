export const ActiveProjectsData = [
    {
       ...
       hours: 34,
       progress: 15,
       brandLogo:'/images/brand/dropbox-logo.png',
    ...
    },
    {
        ...
        hours: 47,
        progress: 35,
        brandLogo:'/images/brand/slack-logo.png',
        brandLogoBg : 'bg-white',
        members:[
     ...
     },
     {
        ...
        hours: 120,
        progress: 75,
        brandLogo:'/images/brand/github-logo.png',
        brandLogoBg : 'bg-white',
        members:[
     ...
     },
     {
        ...
        hours: 89,
        progress: 63,
        brandLogo:'/images/brand/3dsmax-logo.png',
        brandLogoBg : 'bg-white',
        members:[
     ...
     },
     {
        ...
        hours: 108,
        progress: 100,
        brandLogo:'/images/brand/layers-logo.png',
